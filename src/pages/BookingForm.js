...
const BookingForm = () => {
  ...
  return (
    <section className="container my-3" style={{ maxWidth: "970px" }}>
      <h2 id="h2-form">Reserve a table</h2>
      <form onSubmit={handleSubmit} className="row justify-content-center">
        <div className="personal d-flex">
          ...
          <div className="mb-3">
            ...
            <input
              ...
              name="email"
              id="email"
              placeholder="emily.gold@gmail.com"
              className="form-control"
              value={name.email}
              onChange={handleName}
              required={true}
        ...
        <div className="time d-flex">
          ...
          <div className="mb-3">
            ...
            <select name="date" id="date" className="form-select" value={time} onChange={handleTime}>
              <option defaultValue hidden>Select Time</option>
        ...
        <div className="occasion d-flex">
          ...
          <div className="mb-3">
            <label htmlFor="date" className="form-label">Occasion</label>
            <select name="date" id="date" className="form-select" value={occasion} onChange={handleOccasion}>
              <option defaultValue hidden>Select Occasion</option>
        ...
        <button type="submit" className="confirm-btn" disabled={!isGood()}>
          Confirm Reservation
        </button>
      </form>
    </section>
